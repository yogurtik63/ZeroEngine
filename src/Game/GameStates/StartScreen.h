...
public:
    ...
    static constexpr unsigned int CURSOR_SIZE = 16;
...
private:
    ...
    std::pair<std::shared_ptr<RenderEngine::Sprite>, glm::vec2> m_cursorSprite;
    RenderEngine::SpriteAnimator m_cursorAnimator;
};